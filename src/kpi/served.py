"""KPI 3 - Served Ratio. The share of UEs the network actually serves.

Maximised, and the only KPI counted over UEs rather than grid tiles, so it
inherits whatever bias the MDT sampling has.
"""
