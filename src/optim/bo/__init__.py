"""TuRBO over the absolute-tilt space — PROJECT.md section 13.
...
contracts on failure. ``T_t`` is always a subset of ``X`` (PROJECT.md section
13.2) — it narrows the search, never the constraint.
...
problem (PROJECT.md sections 13 and 14).
"""
