...
LABELS = {
    ...
    "init_median": "Initial design, median objective",
    "candidate_median": "All candidates, median objective",
    "candidate_p90": "All candidates, 90th percentile objective",
    "winner": "Best objective found",
    "reference": "Reference",
    "n_pairs": "Seed pairs",
    "mean_gain": "Mean objective gain",
    ...
    "prb_load": "PRB load",
    "mean_prb": "Mean PRB load",
    "peak_prb": "Peak PRB load",
    "max_prb": "PRB limit",
    "served_reports": "Served reports",
    "peak_utilisation": "Peak PRB utilisation",
    "median_sinr_db": "Median SINR [dB]",
    "median_prb": "Median requested PRB",
    "weight": "Tile weight",
    "tiles_reported": "Tiles with an MDT report",
    "bandwidth_m": "KDE bandwidth [m]",
    "uniform_share": "Uniform share of the weight",
